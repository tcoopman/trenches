...
function view(model) {
  var match = model[/* join_error */1];
  if (match) {
    return div$2(/* None */0, /* None */0, /* :: */[
                class$prime("ui error message"),
                /* [] */0
              ], /* :: */[
                div$2(/* None */0, /* None */0, /* :: */[
                      class$prime("header"),
                      ...
                      text$1("Fatal error while joining the game"),
                      /* [] */0
                    ]),
                /* :: */[
                  p(/* None */0, /* None */0, /* [] */0, /* :: */[
...
function lobby_payload_to_game_list(payload) {
  ...
  if (is_nil_undef(game_objects)) {
    ...
    var games = map$1(game_object_to_game, to_list(game_objects));
    return /* Some */[games];
  }
}
...
function view_games(games_option) {
  ...
  if (games_option) {
    return div$2(/* None */0, /* None */0, /* :: */[
                ...
                /* [] */0
              ], map$1(view_game, games_option[0]));
  } else {
    return div$2(/* None */0, /* None */0, /* :: */[
...
function main$1(param, param$1) {
  return standardProgram(partial_arg$1, param, param$1);
}
